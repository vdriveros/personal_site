...
**Repository:** [Courses Management API](https://github.com/vdriveros/courses_api)

A comprehensive RESTful API built with Laravel for managing online courses, student enrollments, and course content.

**Description:**
Complete course management system that enables educational institutions to manage courses, students, and enrollments efficiently. Features Laravel Sanctum authentication for secure API access and comprehensive CRUD operations.
